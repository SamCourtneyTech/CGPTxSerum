    ...
    std::thread([this, userPrompt, callback]() {
        ...
        for (int i = 0; i < numResponses; ++i)
        {
            threads.emplace_back([&, i]() {
                ...
                const juce::String apiKey = "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"; 
